class Song:
    ...
    Attributes: title (str): The title of a song.
    artist (string): The name of the song's creator.
...
class Album:
    """ Class represents an Album, using it's track list

    Attributes:
        name (str): The name of the album.
        year (int): The year album was released.
        artist: (string): The name of the artist responsible for the album. If not specified,
        the artist will default to an artist with the name "Various Artists".
        tracks (List[Song]: A list of the songs on the album.

    Methods:
        addSong: Used to add a new song the the album's track list
    """
    ...
    def add_song(self, song, position=None):
        """ Adds songs to the track list

        Args:
            song (Song): The title of song to add.
            position (Optional[int]): If specified, the song will be added to the position
                in the track list - inserting it between other songs if necessary.
                Otherwise, the song will be be added to the end of the list.
        """
    ...
    def add_album(self, album):
        ...
        Args:
            album (Album): Album object to add to the list.
                If the album is already present, it will not be added again (although this is not yet implemented).
        """
